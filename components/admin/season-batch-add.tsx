        ...
        <>
          <div className="grid grid-cols-3 gap-2.5 sm:grid-cols-4 sm:gap-3 md:grid-cols-5">
            {candidates.map((candidate) => {
              ...
              return (
                <label
                  className={`relative flex flex-col overflow-hidden rounded-2xl border p-1.5 transition-colors focus-within:outline-3 focus-within:outline-offset-2 focus-within:outline-pink-300 ${
                ...
                >
                  <input
                    ...
                    type="checkbox"
                  />
                  <div className="relative aspect-[2/3] overflow-hidden rounded-xl border border-white/70 bg-white/35">
                    {candidate.cover ? (
                      <CoverImage
                        alt=""
